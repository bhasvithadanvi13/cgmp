...
app.config['SQLALCHEMY_DATABASE_URI'] = f'sqlite:///{os.path.join(instance_dir, "cgmp.db")}'
...
def db_viewer():
    ...
    return render_template('db_viewer.html', users=users, complaints=complaints, feedbacks=feedbacks, resolved=resolved)
